import { ActivityType, DistractionFactor } from './types';
...
export const DISTRACTION_OPTIONS: DistractionFactor[] = [
  DistractionFactor.Phone,
  DistractionFactor.SocialMedia,
  DistractionFactor.Noise,
  DistractionFactor.MindWandering,
  DistractionFactor.People,
  DistractionFactor.Other,
];
...
export const ICONS = {
    ...
    BRAIN: (
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.94-3.43 2.5 2.5 0 0 1 .13-4.28 2.5 2.5 0 0 1 2.37-1.17 2.5 2.5 0 0 1 2.5-2.5Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.94-3.43 2.5 2.5 0 0 0-.13-4.28 2.5 2.5 0 0 0-2.37-1.17 2.5 2.5 0 0 0-2.5-2.5Z"/></svg>
    )
};